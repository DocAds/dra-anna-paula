...
export function TrackingScripts() {
  ...
  // Consentimento de marketing controla Meta/TikTok e a captura de gclid/fbclid.
  useEffect(() => {
...
${m.googleAdsId ? `gtag('config', '${m.googleAdsId}', {allow_enhanced_conversions:true});` : ""}`}
      ...
      {/* Meta Pixel — só após consentimento de marketing (sem consent mode nativo) */}
      {marketingOk && m.metaPixelId && (
      ...
      {/* TikTok Pixel — só após consentimento de marketing */}
      {marketingOk && m.tiktokPixelId && (
